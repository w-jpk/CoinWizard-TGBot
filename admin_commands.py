...
async def admin_commands_list(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    commands = (
        ...
        "1. /add\_balance <user\_id> <amount> - Пополнить баланс пользователя.\n"
        "Пример: `/add_balance 12345 500`\n\n"
        "2. /withdraw\_funds <user\_id> <amount> - Вывести средства пользователю.\n"
        "Пример: `/withdraw_funds 12345 500`\n\n"
        "3. /verify\_user <user\_id> <0|1> - Изменить статус верификации пользователя.\n"
        "Пример: `/verify_user 12345 1`\n\n"
        "4. /set\_balance <user\_id> <new\_balance> - Установить новый баланс пользователю.\n"
