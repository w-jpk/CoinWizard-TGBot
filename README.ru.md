...
- ### 20.01.2025
  ...
  - Реферальная система перенеса в "🔷 О сервисе";
  - Добавлены новые криптовалюты;
  - Добавлен функционал обработки криптовалют;
  - Внесены изменения в игру;
  - Обновлена реферальная система: новый пользователь ничего не получит, а автор сссылки получит 1.000₽ на баланс.