...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ("💼 Личный Кабинет", "⬅️ Назад в личный кабинет"):
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("📩 Написать", url="https://t.me/julius_56")] # Поменяйте ссылку на свой аккаунт
        ])
...
# Формируем текст сообщения для верификации
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("💬 Связаться с тех. поддержкой", url="https://t.me/julius_56")] # Поменяйте ссылку на свой аккаунт
        ])
